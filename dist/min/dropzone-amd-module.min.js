              ...
              [
                  ...
                  value: function (e) {
                    ...
                    this._transformFiles(e, function (n) {
                      ...
                      if (e[0].upload.chunked) {
                        ...
                        if (
                          ((o.upload.finishedChunkUpload = function (n) {
                            var r = !0
                            ;(n.status = i.SUCCESS),
                              (n.dataBlock = null),
                              (n.xhr = null)
                            for (var a = 0; a < o.upload.totalChunkCount; a++) {
                              if (void 0 === o.upload.chunks[a]) return u()
                              o.upload.chunks[a].status !== i.SUCCESS &&
                                (r = !1)
                            }
                            r &&
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    if (void 0 !== n) {
                      if (
                        ((r = (100 * n.loaded) / n.total), e[0].upload.chunked)
                      ) {
                        var i = e[0],
                        ...
                        for (var a = 0; a < i.upload.totalChunkCount; a++)
                          void 0 !== i.upload.chunks[a] &&
                            void 0 !== i.upload.chunks[a].progress &&
                            ((i.upload.progress += i.upload.chunks[a].progress),
                            (i.upload.total += i.upload.chunks[a].total),
                            (i.upload.bytesSent +=
                              i.upload.chunks[a].bytesSent))
                        i.upload.progress =
                      ...
                      try {
                        for (b.s(); !(m = b.n()).done; ) {
                          var x = m.value
                          this.emit('uploadprogress', x, r, x.upload.bytesSent)
                        }
                      } catch (e) {
                        b.e(e)
                      } finally {
